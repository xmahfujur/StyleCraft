  ...
  return (
    <div className="pt-20 md:pt-24 pb-20 md:pb-0">
      ...
      <section className="relative h-[85vh] md:h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          <motion.h1 
            ...
            className="text-4xl sm:text-5xl md:text-6xl font-serif mb-6 tracking-tighter leading-tight text-white uppercase italic font-black"
          >
      ...
      */}
      ...
      {/* 5. 🛍️ FEATURED PRODUCTS (ABOVE THE FOLD ON MOBILE) */}
