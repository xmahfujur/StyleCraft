        ...
        {showConfirm && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
            ...
            <motion.div 
              ...
              className="relative bg-white border border-black/10 p-10 md:p-14 max-w-xl w-full shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)] rounded-[3rem]"
            >
              <h2 className="text-3xl md:text-4xl font-serif mb-10 tracking-widest text-center text-black font-bold uppercase italic">Confirm Order</h2>
              
              <div className="space-y-8 mb-12">
                <div className="bg-black/5 p-6 rounded-2xl border border-black/5 shadow-inner">
                  <p className="text-[10px] tracking-[0.3em] text-black/40 uppercase mb-4 font-black">Ship To:</p>
                  <div className="text-lg space-y-2 text-black/80 font-bold italic leading-tight">
                    <p className="text-black font-black uppercase not-italic">{formData.fullName}</p>
                    <p>{formData.phone}</p>
                ...
                <div className="space-y-4">
                  <div className="flex justify-between text-base px-2">
                    <span className="text-black/40 uppercase tracking-[0.2em] font-black">Subtotal</span>
                    <span className="text-black font-black font-mono">৳{total}</span>
                  </div>
                  <div className="flex justify-between text-base px-2">
                    <span className="text-black/40 uppercase tracking-[0.2em] font-black">Delivery</span>
                    <span className="text-black font-black font-mono">৳{deliveryCharge}</span>
                  </div>
                  <div className="flex justify-between text-3xl font-serif border-t-2 border-black/10 pt-6 mt-6 text-black px-2">
                    <span className="tracking-widest font-black italic">TOTAL</span>
                    <span className="text-red-600 font-black font-mono">৳{finalTotal}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <button 
                  onClick={() => setShowConfirm(false)}
                  className="py-5 border-2 border-black/10 text-black/40 tracking-[0.2em] text-xs uppercase hover:bg-black hover:text-white transition-all duration-300 font-black rounded-full"
                >
                  Go Back
                </button>
                <button 
                  ...
                  className="py-5 bg-black text-white font-black tracking-[0.2em] text-xs uppercase hover:bg-red-600 transition-all duration-300 disabled:opacity-50 rounded-full shadow-xl active:scale-95"
                >
