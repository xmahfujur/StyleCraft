                        ...
                        <div className="space-y-3">
                          ...
                          {order.shippingAddress ? (
                            <div className="text-xs text-white/60 space-y-1">
                              ...
                              <p>{order.shippingAddress.addressLine}, {order.shippingAddress.area}</p>
                    ...
                    <section>
                      ...
                      {viewingOrder.shippingAddress ? (
                        <div className="space-y-2 text-sm text-white/70">
                          ...
                          <p>{viewingOrder.shippingAddress.addressLine}, {viewingOrder.shippingAddress.area}</p>
                ...
                <div className="space-y-1 text-sm">
                  {printingOrder.shippingAddress ? (
                    <>
                      ...
                      <p className="opacity-80">{printingOrder.shippingAddress.addressLine}, {printingOrder.shippingAddress.area}</p>
                      <p className="opacity-80">{printingOrder.shippingAddress.city}, {printingOrder.shippingAddress.state} - {printingOrder.shippingAddress.postalCode}</p>
