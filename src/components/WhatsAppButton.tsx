  ...
  return (
    ...
    >
      <div className="relative">
        ...
        <div className="relative bg-luxury-black border border-gold/30 text-[#25D366] p-4 rounded-full flex items-center justify-center shadow-2xl hover:border-[#25D366] transition-colors">
          <svg 
            viewBox="0 0 24 24" 
            width="24" 
            height="24" 
